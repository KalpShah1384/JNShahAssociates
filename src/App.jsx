  ...
  return (
    <AnimatePresence mode="wait" onExitComplete={() => window.scrollTo({ top: 0, left: 0, behavior: 'instant' })}>
      <Routes location={location} key={location.pathname}>
        ...
        {/* Deep Service Routes */}
        <Route path="/services/tax" element={<PageWrapper><DirectTax /></PageWrapper>} />
        <Route path="/services/gst" element={<PageWrapper><GSTSolutions /></PageWrapper>} />
        <Route path="/services/audit" element={<PageWrapper><AuditAssurance /></PageWrapper>} />
        <Route path="/services/advisory" element={<PageWrapper><BusinessAdvisory /></PageWrapper>} />
        <Route path="/services/compliance" element={<PageWrapper><ComplianceManagement /></PageWrapper>} />
        <Route path="/services/international" element={<PageWrapper><InternationalTax /></PageWrapper>} />
        ...
        <Route path="/security" element={<PageWrapper><SecurityPolicies /></PageWrapper>} />
