...
const KnowledgeHub = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fb]">
            ...
            {/* Header Section */}
            <section className="bg-brand-navy pt-28 pb-20 md:pt-36 md:pb-32 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        <div className="flex items-center space-x-3 text-brand-ice mb-6">
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white font-heading leading-tight mb-6">
                            Statutory Knowledge <span className="text-brand-ice italic">Vault</span>
                        </h1>
                                ...
                                <div className={viewMode === 'list' ? 'flex-1' : ''}>
                                    <div className="flex justify-between items-center mb-8">
                                        <div className="flex items-center space-x-2 text-[10px] font-black uppercase text-brand-navy/30 tracking-widest">
                                            ...
                                            <span>{article.pubDate ? new Date(article.pubDate).toLocaleDateString('en-IN', { day: '2-digit', month: 'long', year: 'numeric' }) : 'STATUTORY UPDATE'}</span>
                                        </div>
                                    ...
                                    <div className="mt-auto pt-6 border-t border-brand-ice flex flex-wrap items-center justify-between gap-4">
                                        <a
                                            href={article.link}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center space-x-2 text-brand-primary text-[11px] font-black uppercase tracking-widest hover:translate-x-1 transition-transform group"
                                        >
                                            <span className="group-hover:underline decoration-2 underline-offset-4">Detailed circular</span>
                                            <ExternalLink className="w-3.5 h-3.5" />
                                        </a>
                                        {article.source_id && (
                                            <div className="flex flex-col items-end">
                                                <span className="text-[8px] font-black text-brand-navy/20 uppercase tracking-widest leading-none mb-1">Source</span>
                                                <span className="text-[9px] font-black text-brand-navy/40 uppercase tracking-tighter truncate max-w-[120px]">{article.source_id}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
