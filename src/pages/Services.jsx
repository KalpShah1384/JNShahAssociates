...
const Services = () => {
  ...
  return (
    <div className="pt-28 pb-24">
      <SEO
        title="Chartered Accountant Services in Vadodara"
        description="Explore JN Shah Associates' full-service chartered accountancy offerings including Direct Tax, GST, Audit & Assurance, Business Advisory, Compliance Management, and International Tax."
        keywords="CA services Vadodara, tax filing, GST registration, audit, business advisory, compliance management, international tax"
      />
      {/* Header */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold mb-8 text-brand-navy leading-[1.2]">
            Our <span className="text-brand-primary italic">Service</span>{" "}
            Verticals
          </h1>
          ...
          <p className="text-corporate-text text-lg md:text-xl max-w-3xl mx-auto leading-relaxed font-medium tracking-wide">
            From strategic tax planning to operational audits, we provide a
            360-degree financial ecosystem tailored for startups, SMEs, and
            corporate entities.
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {serviceCategories.map((cat, idx) => (
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-8 text-brand-navy group-hover:text-brand-primary transition-colors">
                {cat.title}
              </h2>
              <ul className="space-y-4 flex-grow mb-10 w-full">
                {cat.services.map((service, sIdx) => (
                  <li
                    key={sIdx}
                    className="flex items-center justify-center sm:justify-start text-corporate-text hover:text-brand-primary transition-colors"
                  >
              ...
              <Link
                ...
                className="mt-auto flex items-center justify-center sm:justify-start text-brand-primary font-extrabold text-sm uppercase tracking-wider group-hover:translate-x-2 transition-transform"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="text-white">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight">
                ...
                <span className="text-brand-primary">Domain Knowledge</span>
              </h2>
              <p className="text-brand-ice/80 mb-10 text-lg font-medium leading-relaxed">
                We go beyond generic accounting. Our team brings specialized
                regulatory knowledge for niche sectors, ensuring your business
                stays compliant with minimal friction.
              </p>
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center space-x-3 bg-white/5 p-4 rounded-2xl border border-white/10 hover:border-brand-primary transition-colors"
                  >
            ...
            <div className="bg-white/5 backdrop-blur-xl p-12 rounded-[3rem] border border-white/10 shadow-3xl">
              ...
              <p className="text-brand-ice/70 mb-10 text-lg font-medium leading-relaxed">
                Have a complex holding structure or cross-border tax
                requirements? We design custom compliance frameworks for even
                the most intricate business models.
              </p>
              <Link
                to="/book"
                className="btn-primary w-full block text-center py-5"
              >
